...
#   ip_address = data.google_compute_address.this.address  # Public IP of the peer VPN gateway (GCP side)
...
#   destination_cidr_block = google_compute_subnetwork.cidr.ip_cidr_range  # The peer CIDR block (GCP)
# }
...
#   vpc_id      = data.aws_vpc.this.id  # Attach to AWS VPC

#   ingress {
#     from_port        = 0
#     to_port          = 0
#     protocol         = "-1"  # All protocols
#     cidr_blocks      = [ google_compute_subnetwork.cidr.ip_cidr_range ]  # Allow from GCP subnet only
#   }
